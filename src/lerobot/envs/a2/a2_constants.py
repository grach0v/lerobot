"""A2 Environment constants.

This module contains workspace limits, language templates, object labels,
and direction mappings for the A2 simulation environment.
"""
...
# Train object labels (simplified_objects)
...
# Test object labels (unseen_objects)
