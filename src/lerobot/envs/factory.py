...
from lerobot.envs.configs import A2EnvConfig, AlohaEnv, EnvConfig, HubEnvConfig, IsaaclabArenaEnv, LiberoEnv, PushtEnv
...
def make_env(
    ...
    if "libero" in cfg.type:
        ...
        from lerobot.envs.a2 import create_a2_envs

        return create_a2_envs(
            task=cfg.task,
            n_envs=n_envs,
            gym_kwargs=cfg.gym_kwargs,
            camera_name=cfg.camera_name,
